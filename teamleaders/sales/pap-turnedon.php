...
<div class="clearfix"></div>
    ...
    <div class="container-fluid">
      ...
      <div class="row mt-3">
          ...
          <div class="card">
            ...
            <div class="card-body">
            <center> <h5 class="card-title">Pap Turned On</h5></center>
  ...
  <tbody>
  <?php
                        $query  = "SELECT turnedonpap.ClientName,turnedonpap.ChampName,turnedonpap.ClientContact,turnedonpap.BuildingName,turnedonpap.BuildingCode,turnedonpap.Region,turnedonpap.DateTurnedOn,papdailysales.Floor FROM turnedonpap JOIN papdailysales ON papdailysales.ClientID=turnedonpap.ClientID WHERE turnedonpap.ClientID IS NOT null";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <th><?php echo $row['DateTurnedOn']; ?></th>
                                </tr>
                        <?php
