  ...
  <!--Start Dashboard Content-->
    ...
    <div class="card-content">
        <div class="row row-group m-0">
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0">0 <span class="float-right"><i class="fa fa-usd"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
                  <p class="mb-0 text-white small-font">Current Amount <span class="float-right"><!--<i class="zmdi zmdi-long-arrow-up"></i>--></span></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Today's Amount<span class="float-right"><!--<i class="zmdi zmdi-long-arrow-up"></i>--></span></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">PAP Installed <span class="float-right"><!--<i class="zmdi zmdi-long-arrow-up"></i>--></span></p>
                </div>
            </div>
                  ...
                  <h5 class="text-white mb-0"> <?php
                                            $query="SELECT  COUNT(techieteams.Team_ID)as MyTask from papdailysales LEFT JOIN techietask on techietask.ClientID=papdailysales.ClientID LEFT JOIN techieteams ON techieteams.Team_ID=techietask.TeamID  LEFT JOIN papinstalled ON papinstalled.ClientID=papdailysales.ClientID WHERE 
                                             ...
                                             echo $row['MyTask']."<br><br>";
                                              ...
                                              ?><span class="float-right"><i class="fa fa-tasks"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
                  <p class="mb-0 text-white small-font">My Task <span class="float-right"><!--<i class="zmdi zmdi-long-arrow-up"></i>--></span></p>
                </div>
            </div>
        </div>
    </div>
	...
	<div class="row">
     ...
     <div class="col-12 col-lg-4 col-xl-4">
        <div class="card">
           <div class="card-header">Weekly Material Usage
             <div class="card-action">
             <div class="dropdown">
             <a href="javascript:void();" class="dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown">
              <i class="icon-options"></i>
          ...
          <div class="table-responsive">
             <table class="table align-items-center">
               <tbody>
                 <tr>
                   <td><i class="fa fa-circle text-light-3 mr-2"></i> </td>
