...
<div class="form_wrapper">
  <div class="form_container">
    <div class="title_container">
      <h2><img class="user" src="../assets/login.png" height="100px" width="100px"></h2>
    </div>
    <div class="row clearfix">
      <div class="">
        <form method="POST">
          ...
          <center> <span style="font-family: Georgia;" id='message'> </span></center> </br>
          <center> <span style="font-family: Georgia;" id='message'> </span></center> </br>
          <input class="button" id="submit" name="submit" type="submit" value="Login" />
          <p class="link"></p><a href="../users/registration.php" ><center>Register</center></a>
        </form>
      </div>
    </div>
  </div>
