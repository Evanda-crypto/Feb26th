...
<div class="clearfix"></div>
    ...
    <div class="container-fluid">
      ...
      <div class="row mt-3">
          ...
          <div class="card">
            ...
            <div class="card-body">
            <center> <h5 class="card-title">My Turned on Pap</h5></center>
  ...
  <tbody>
  <?php
                        $query  = "SELECT turnedonpap.ChampName,turnedonpap.ClientContact,turnedonpap.BuildingName,turnedonpap.BuildingCode,turnedonpap.Region,turnedonpap.DateTurnedOn,papdailysales.Floor,papdailysales.ClientName FROM turnedonpap JOIN papdailysales ON papdailysales.ClientID=turnedonpap.ClientID WHERE turnedonpap.ClientID IS NOT null and turnedonpap.ChampName='".$_SESSION['FName']." ".$_SESSION['LName']."'";
