...
<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content-->
    ...
    ?><span class="float-right"> <i class="fa fa-check"></i></span></h5>
                  ...
                  <p class="mb-0 text-white small-font">Pap Signed[Last 7 days] <span class="float-right"><!--<i class="zmdi zmdi-long-arrow-up"></i></span>--></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
    ...
    ?><span class="float-right"><i class="fa fa-usd"></i></span></h5>
                  ...
                  <p class="mb-0 text-white small-font">My Sales <span class="float-right"><!-- <i class="zmdi zmdi-long-arrow-up"></i>--></span></p>
                </div>
            </div>
    ...
    ?><span class="float-right"><i class="fa fa-tasks"></i></span></h5>
                  ...
                  <p class="mb-0 text-white small-font">Tasks <span class="float-right"><!--<i class="zmdi zmdi-long-arrow-up"></i>--></span></p>
                </div>
            </div>
        </div>
    </div>
