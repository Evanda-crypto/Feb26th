                ...
                <div class="tab-pane" id="edit">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="<?php echo $_SESSION['FName'];?> ">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Last name</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value=" <?php echo $_SESSION['LName'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Email</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="email" value=" <?php echo $_SESSION['Sales'];?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="reset" href="SalesDashboard.php" class="btn btn-secondary" value="Cancel">
                                <input type="button" class="btn btn-primary" name="submit" value="Save Changes">
                            </div>
                        </div>
                    </form>
                </div>
