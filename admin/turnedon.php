  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" name="bname" id="input-2" placeholder="Building Name" value="<?php echo $bname?>"  required>
           </div>
           <div class="form-group">
            <label for="input-2">Building Code</label>
            <input type="text" class="form-control" name="bcode" id="input-2" placeholder="Building Code" value="<?php echo $bcode?>"  required>
           </div>
           <div class="form-group">
            <label for="input-2">Pap Status</label>
            <input type="text" class="form-control" name="status" id="input-2" placeholder="Pap Status" value="Turned On"  readonly>
           </div>
           <div class="form-group">
            <label for="input-2">Date Turned On</label>
            <input type="date" class="form-control" name="date" id="input-2" placeholder="Date Turned On"  required>
           </div>
           <div class="form-group">
     ...
     <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Turned On Pap  <div class="form-outline">
              ...
              <table class="table table-hover" id="myTable">
                ...
                <tbody>
                  ...
                  <?php
                          ...
                          $sql="select PapCode,ClientName,ClientContact,BuildingName,Region,upper(MacAddress) as MacAddress  from turnedonpap where DateTurnedOn=CURDATE()";
                          $result=mysqli_query($connection,$sql);
                          if($result){
