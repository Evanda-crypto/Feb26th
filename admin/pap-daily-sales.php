      ...
      <div class="row mt-3">
          <div class="card">
            ...
            <center>  <h5 class="card-title">PAP DAILY SALES</h5></center>
              <div class="form-outline"><input type="search" id="myInput" style="width:10%; margin-left:2%; margin-bottom:2%;" onkeyup="myFunction()"class="form-control" placeholder="Search by Name.." aria-label="Search" /></div>
